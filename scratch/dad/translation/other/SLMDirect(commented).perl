...
$webSwitch = 0; #choose perl interpreter
my($repository) = ".";
if ($webSwitch) {
...
#use strict 'vars';
my($wordnet_available) = 0; #import wordnet
if (!$webSwitch) {
...
if (($do_autotag || $do_synonyms) && $wordnet_available) { #activate wordnet
